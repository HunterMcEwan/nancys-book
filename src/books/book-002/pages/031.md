...
content_types:
  ...
  - family tree
transcribed: true
notes: "Phase 2 enhanced pass: major corrections from the high-resolution scan. (1) 'Mrs. Thos. Matchie' is in fact 'Mrs. Thos. Hanckel' — a well-attested Charleston family name (Rev. Christian Hanckel, etc.). (2) The Steele children were 'brougnt up at Sewanee by Miss Maria Porcher' — phase 1 misread 'Porcher' as 'Forster' twice and misread the Tennessee location 'Sewanee' as 'Newark'. (3) The three Steele sons are 'Edwin, Harold and Willie', not 'Hadley, Witsell and Eliza' (phase 1 confused these). (4) Edwin (the younger) married 'Miss Ashby', not 'Miss Sophy'. (5) Dr. Edwin Steele (the elder) 'married Miss Porcher', not Miss Forster. (6) 'Mrs. Ben Black' is 'Mrs. Sam Black'. (7) Most consequentially: Minnie called her aunt Maria Ann Perry 'Amy', not 'Ang' — this is the namesake source for the compiler 'Amy Ann Perry FitzSimons'. A typewritten sheet headed 'Written by Minnie Perry FitzSimons,' recording family genealogy received from her grandfather and other relations. Page 1 of a two-page memorandum continued on sheet 032. Names and spellings preserved as typed; standard frontmatter form FitzSimons is used in metadata."
---
