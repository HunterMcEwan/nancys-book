...
content_types:
  ...
  - memorandum
transcribed: true
notes: "Album page with five sepia photographs of the infant Amy Perry 'Buzzie' Walker (Amy and J.P. Walker's first child) mounted in two clusters — two small oval baby portraits at upper left and upper center, and three rectangular snapshots in a horizontal row at lower left. Handwritten captions in blue ink record her birth in Roper Hospital on 20 Mar 1910, death in Weldon NC on 30 Jun 1911, and burial in the FitzSimons lot at Magnolia Cemetery, Charleston. Enhanced re-read corrected the bottom-right caption: the dark-clad attendant is 'Maum Hinda' (a family nursemaid), not 'Nurse Hooker' — Amy uses the Lowcountry 'Maum' (mauma) honorific. The grandmother caption reads 'Buzzy + Mim mie' (Amy's shorthand for her mother, 'Mam'mie' Mary Anne Perry FitzSimons)."
---
