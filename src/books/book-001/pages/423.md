...
content_types:
  - letter
transcribed: true
notes: "Phase 2 enhanced pass — body text confirmed against high-resolution scan; no transcription corrections needed. The metadata `people:` list has been tightened: phase 1 had over-attributed several people as 'Green' surnames; from the letter alone we cannot tell whether Marcia, Rick, Pinka, Robert, Chris, Cindy, Christopher etc. are Greens, McEwans, or married-in relations. 'Betty and O.B.' are Mary Ann Walker McEwan ('Betty') and Oswald Beverley McEwan — Nancy's parents — so re-attributed McEwan; 'Chris and Cindy' on Pine Island are likely Nancy's brother Christopher Gaillard McEwan and his wife, so likewise McEwan. 'Unc' is referenced affectionately and is plausibly Robert (Pinka's husband), but unconfirmed. Typed single-spaced on plain bond, dated Feb. 26, 1986, signed in blue ink 'Love, Nancy' with a closing 'over' arrow at the lower right. From Nancy McEwan Green (daughter of Mary Ann Walker McEwan, granddaughter of compiler Amy FitzSimons Walker) to her aunt Ann Seymour Knight (Mrs. James Pickens Walker Jr.) of Jacksonville. Continues on page 424."
---
