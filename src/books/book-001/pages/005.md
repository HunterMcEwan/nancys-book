...
notes: "A 1965 follow-up to the Thomas FitzSimons 'Patriot Without a Face' story already pasted in on page 004. The DAR (Daughters of the American Revolution) reopens the search for a likeness; a Gilbert Stuart portrait at a Philadelphia home is identified as a possible match. The compiler added two pencilled annotations — one speculating about a family connection, one identifying the source paper and date. Phase-2 (2026-05-13): full-resolution re-read confirms the article body, the upper pencilled annotation 'He must be one of your long lost ancestors!' (single exclamation, unlike the double-bang version on p004), the lower pencilled source citation 'Richmond Times Dispatch · March 17 1965', and the AP Wirephoto caption identifying the Gilbert Stuart portrait in Samuel Edelson's Philadelphia home. The county-of-birth name in the article remains too faintly inked/cropped to read with confidence."
---
