...
notes: "Two newspaper clippings pasted to the album page. The upper clipping carries a small portrait captioned 'ALLISON' and is the lead article 'Episcopalians To Consecrate Bishop,' announcing the upcoming consecration of the Rev. Dr. C. FitzSimons Allison as bishop coadjutor of the Episcopal Diocese of South Carolina (the actual consecration took place 25 September 1980 at Gaillard Municipal Auditorium, Charleston). Below it is an unrelated clipping fragment about troops and warplanes — apparently a piece of newsprint that came with the Allison article and was pasted in incidentally. Lower-right of the page is a third unrelated narrow column fragment on Victorian-era social criticism. Phase 2 enhanced pass corrected several misreadings: the co-consecrator from East Carolina is **B. Sidney Sanders** (not 'C. Sidney Sanders') and his diocese is **East Carolina** (not 'Eastern Carolina'); Martha Allston Parker is from **Georgetown, South Carolina** (not 'Pennsylvania'); Trinity Episcopal School for Ministry is in **Sewickley, Pa.** (the Sewanee/Tennessee location was a phase-1 conflation with Dr. Allison's University of the South alma mater). The continuation reference reads 'See BISHOP, Page 2-B, Col. 2' (phase-1 had 'Col. 1')."
---
