...
notes: "A page torn from the reference directory 'Who's Who in Railroading in North America' (most likely the 1940 edition, published every few years by Simmons-Boardman). The printed page-folio number 660 is visible top left. Multiple two-column biographical entries in tight reference-book typography. A pencilled marginal annotation top right reads 'Sigma Ribbon Society' — purpose unclear (perhaps the album-compiler's later note flagging a society membership not listed in print). Below the James Pickens Walker entry, a handwritten correction in pencil overwrites the printed home address ('3657 Richmond St., Jacksonville, Fla.') with '3690 Hedrick' — Amy or J.P. Sr. himself updating the address to the family's later Jacksonville street. Phase-2 enhanced pass made substantial corrections: birth year 1883 (not 1885), birth town Overfield (not Overland), marriage date Oct. 20, 1908 (not Oct. 26), Emma D. (not Emma H.) Pickens, children list J. P. Jr., Dee, Mary Ann (not 'J. P. Jr., Dec.'); Horace L. Walker born Lancaster Ky. (not Lexington), wife Elizabeth Wyne (not Lillian L. Wright); J. F. Walker (not J. P. Walker) Illinois Central; James Littleton Walker born June 30, 1885 (not Nov. 13, 1881), wife Edna Earl Outten (not Edith Jones); John D. Walker (not James Jerome Walker) Colorado & Southern, wife Macey L. E. Palmer (not Mary E. Palmer); Walkmeyer, John Henry (not Walker, John Henry) — a separate surname entirely; Frank Jerome Wall in New Haven & Hartford RR (entry runs off the page bottom)."
---
...
*[Phase 2 enhanced pass corrections vs phase 1:*
*— James Pickens Walker Sr.: birth year 1883 (NOT 1885); birthplace Overfield, W. Va. (NOT Overland); mother Emma D. Pickens (NOT Emma H.); marriage Oct. 20, 1908 (NOT Oct. 26); children "J. P. Jr., Dee, Mary Ann" (NOT "J. P., Jr., Dec.; Mary Ann" — "Dee" is the middle child, a nickname, almost certainly the same Dee whose letters appear in book-003); the printed address is struck and overwritten in pencil with "3690 Hedrick."*
*— Horace L. Walker: birthplace Lancaster, Ky. (NOT Lexington); wife Elizabeth Wyne (NOT Lillian L. Wright); office address 1500 (NOT 1100) First & Merchants Natl. Bank.*
*— "Walker, J. P." in phase 1 is actually **Walker, J. F.** (the initials are clearly F not P).*
*— James Littleton Walker: born June 30, 1885 at Portsmouth, Va. (NOT Nov. 13, 1881); wife Edna Earl Outten (NOT Edith Jones).*
*— "Walker, James Jerome" (Colorado & Southern) in phase 1 is actually **Walker, John D.**, born Leadville, Colo., Jan. 26, 1885; wife Macey L. E. Palmer (NOT Mary E. Palmer).*
*— "Walker, John Henry" (Alton/B. & O.) in phase 1 is actually **Walkmeyer, John Henry** — a different surname entirely.*
*— The "Walker, James Pickens" position-list "successively roa, eng., div. engr.,..." is in fact "successively res. engr., div. engr., asst. engr., asst. supt. and supt." (phase-1 garble fixed).*
*— The relationship of "Sigma Ribbon Society" pencil note to the printed content remains unclear; treated as a marginal annotation in the compiler's hand, possibly a memory cue rather than a comment on any specific entry.]*
