...
content_types:
  ...
  - letter
transcribed: true
notes: "Phase 2 enhanced pass — multiple corrections to body of newspaper clipping: Barrett trust officer since 1940 (not 1948), MIT class of 1917 (not 1937), Army-discharged in Charleston 1919 (not 1948), Citadel 1949 (not 1948), assistant trust officer 1953 (not 1952), 46 Broad Street office (the bank's address — phase 1 mis-read this as 'annual stockholders meeting'), Margarita FitzSimons (no 'Consuelo' — that was a phase-1 fabrication), 625 Wappoo Dr. (not 825), signed W. A. Livingston (not J. A. Livingston). Clipping has a single two-column-wide photo of L. W. Barrett (only) at upper left; the captioned partner photo of D. McK. Allston Jr. was apparently never cut from the newspaper or was cropped off. The letter beneath, on W. A. Livingston, Inc. (Wholesale Groceries, Orangeburg, SC) letterhead, is dated 9 March 1957 and offers congratulations on the promotions. The fuller text of this letter is shown on page 577. Mary FitzSimons Allston (Mrs. Donald McKay Allston of Charleston) is the compiler's sister Mary Annie FitzSimons — see the pedigree chart on p629; her son Donald McKay Allston Jr. married another FitzSimons (Margarita) of Hendersonville NC."
---
...
*[Phase 2 enhanced pass: the dense newsprint required pixel-level reading; phase 1 had introduced several errors typical of low-resolution OCR of small body type — most of the year-dates of Barrett's biography were off by a decade or two, and the bank's "46 Broad St. office" had been confused with a generic "annual stockholders meeting." The signature on the letter is "W. A. Livingston" not "J. A. Livingston."]*
