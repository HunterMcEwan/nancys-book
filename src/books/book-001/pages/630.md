...
notes: "Two facing pages of handwritten genealogical notes in faded ink. Left page records the marriage of Julia Virginia Bessellieu (at Pottersville, S.C., by the Rev. Mr. Becker, to B. F. Dunkin Perry) and lists their children. Right page records the marriage of Mary Annie Perry at Columbus, Ga., in the morning of 13 April 1887, by a minister whose name is hard to decipher (reads 'Krenler' or 'Krenter'), to Samuel G. FitzSimons, and lists their children with birth and (where applicable) death dates. Key readings: **Elizabeth Howell**; **Wm. Bee Coffin**; **R.R. accident** (railroad); **Theodore Barker**; **Thomas Porcher**; **Samuel Cashel**; **Amy Perry** (the compiler herself — born 4 Feb 1888); Samuel Gaillard born **September 21st 1904**; **Rose Aldrich** (reading uncertain). The Perry-Bessellieu-Charleston FitzSimons cross-reference confirms the FAMILY-NOTES Perry-Bessellieu maternal-line scaffolding. The 'Dunkin Perry FitzSimons' (b. 8 May 1893, d. 4 Feb 1895) listed as Amy's brother does not match the 'Hunter Perry' name FAMILY-NOTES carries for one of Amy's infant-deceased brothers — possibly a separate child, possibly the same child differently named in different family records."
---
