...
content_types:
  - letter
transcribed: true
notes: "Second sheet of the three-page 'Thursday A.M.' letter that begins on page 358 and closes on page 360 (signed **Minnie**). Cream paper, blue cursive, no salutation; continues the writer's account of Lucia's illness and household plans. Mary Lou is named as Lucia's primary caretaker who 'can manage' as long as her own health holds; Amy goes to 'Sally' Saturday and intends to be with Lucia every morning after breakfast until X-ray time. Lucia does not want 'Marlee' (or the public) to know, only family; news is to be passed to May with assurance the writer is available night-nursing if needed, but McKay is best left where he is happy — May should remind him of his book reports and tell grandaddy to send a [line every now and then — the sentence concludes on page 360]. **Phase-2 enhanced pass corrections**: phase-1 fragmentary words 'every one to leave [a] nice much used' tentatively re-read as 'wanted every one to know — and a nice [letter] sent.' McKay is preserved as a person (a boy, given the book-reports reference). 'Marlee' may be a misreading for 'Marlie' / 'Marie' / 'Marble' — name uncertain. 'Maggie' is likely Maggie Kershaw FitzSimons (Mrs. Frank L. FitzSimons Sr.) — see pp. 532. Henry removed from phase-1 people list — name does not appear on this sheet. Same hand and recipient as the 'Friday night' letter on pp. 355–356."
---
