...
notes: "An open-book scan showing two leaves. The left leaf is paginated **4** at top centre and is the continuation of the wedding letter to Kate (running 189(2/3) → 191L(4) → 193R(5) → 194L(6) → 194R(7) → 193L(8) → 190L(9?) → 190R(10) → 192L(11) → 192R(12) → 195 → 196 → 187/188 Friday). The right leaf opens an ENTIRELY SEPARATE letter dated **Charleston / Thursday Nov.** addressed **My dear Mary**, which discusses the same recently-married couple but is a different letter to a different recipient. The initials **T.G.B.** + **L.P.K.** appear explicitly toward the bottom of the right column — confirming the bride and groom of the wedding letter as **Theodore Gaillard Barker** ('Tody') and **Louisa Preston King**, daughter of Judge Mitchell King. Significant Phase-1 corrections on this page: 'Mr. Hugh Maynes & Arthur' → 'Mrs Huger, Margaret & Arthur' (Charleston Huger family, matching the pencil annotation on page 190L); 'Nell & I' → 'T.G.B. & L.P.K.' in the famous 'reckless of proprieties' line on the right column."
---
