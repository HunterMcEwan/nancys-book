...
notes: "Phase 2 enhanced pass: page number resolved as 'III' (pencilled at upper left). Continuation of a typescript essay on Charleston gardens. The Francis Marion Hotel opened in 1924 and the Fort Sumter Hotel in 1923, so this essay dates after 1924; the 'Mid-Victorianly poetical' frame suggests 1924–c.1940. Phase 1 mis-keyed several words: 'umbra-aanguinaa' → 'umbra-magnoleas' (the writer's coinage for the Magnolia grandiflora's deep shade); 'deeds of arms' → 'Coats of Arms'; 'near pirates' → 'near Otranto' (Otranto Plantation, the historic Goose Creek estate); 'endless noisy way' → 'callous noisy way'; 'tangs of Saint Augustine' → 'tempo of Saint Augustine'; and several smaller fixes (the 'sleeping Beauty of the legend — she is moving in her sleep' clause is in dashes, not 'who is moving')."
---
