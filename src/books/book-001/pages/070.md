...
notes: "The reverse / address-fold side of the Sam'l G. Barker letter on page 069. The sheet is otherwise blank; the three-line address is written across the central fold, sideways, in brown ink. Enhanced pass corrects the surname: the recipient is **Lydia C. Gaillard** (not 'Lydia C. Bullard' as the first pass guessed), and the destination is **'Rocks'** — almost certainly The Rocks plantation, a Gaillard family seat on the Cooper River in St. John's Berkeley Parish, SC."
---
