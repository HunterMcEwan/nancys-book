...
notes: "The foundational page of the family record. Compiled by W. Huger FitzSimons (son of Christopher 3rd and Susan Milliken Barker). Includes the family tree from Cashel FitzSimons + Catherine O'Callaghan down through several generations, plus a prose memorandum and gravestone inscriptions for Christopher FitzSimons (the emigrant) and his wife Catherine. Phase-2 enhanced re-read confirms the family-tree column captions and the cursive viz-list of children (which on this page omits Owen FitzSimons, though the parallel typescript on pages 018/019/023 lists him as the tenth child). The marginal annotations — left margin reference to the 1788 Charleston slate-gazette marriage notice, right margin reference to the 1783 census in the Congressional Library — are confirmed verbatim."
---
...
- **Christopher** (4th) — m. Susan Milliken Barker → Christopher, Samuel Gaillard, Theodore Stoney, Seaman Sinkler, William Huger, Ellen Milliken, Gaillard Stoney
