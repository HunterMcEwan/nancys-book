...
notes: |
  ...
  Susan (Milliken Barker FitzSimons, the writer's aunt and Ellen's
  mother), and Uncle Edward; the writer's mother Ellen Milliken Barker
  (Thomas's other daughter, deceased before this letter).
  Enhanced pass (2026-05-13): the previously-uncertain "Castle's Hein"
  tract is the **Castle Ruin Tract** (canonical name used on pages
  172–177, propagating from the p173 enhancement); Aunt Susan is the
  full canonical "Susan Milliken Barker FitzSimons" (1827–1900); the
  writer's mother is identified as "Ellen Milliken Barker" (1807–1874);
  signatures at the foot of the left leaf reconfirmed as Ellen M.
  FitzSimons and Theodore G. Barker.
---
