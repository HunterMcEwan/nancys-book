...
notes: |
  ...
  honorary-degree letter referenced on page 488. The bracketed
  gap-fillers ("[ton Library Society]", "[our beautiful]", "[fifty
  years of]", "[r very generous]", "[d from active]", "[incere over]",
  "[ressed by warm]", "[s to my heart]", "[s been and is]", "[it is
  best for]") are inferred from natural paragraph rhythm, sentence
  structure, and the convention of typing carbon copies wide enough
  for the entire message. The typewriter typo "overwhwamed" (=
  overwhelmed) and the superscript "1,1" after "October 1" (a date
  repetition / strike-out artifact) are preserved as on the page.
---
