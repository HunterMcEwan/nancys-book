...
notes: "Page 1 of a multi-page typewritten letter from Judge Henry C. Hammond to Amy, June 14, 1940. Written on Hammond, Kennedy & Yow letterhead from Augusta, GA. Hammond replies to Amy's family-history inquiry — originally addressed to Mary Gwynn Hammond at Kathwood, S.C. — with a striking opening preamble on the unreliability of family tradition. The letter continues onto the following scan. Phase-2 (2026-05-13): full-resolution re-read confirms the typewritten body verbatim; the upper-right pencil 'Note 3 –' is clearly in Amy's own hand and likely her filing index for Hammond's series of replies (cf. the captioned envelope on p004). The letterhead's three named partners are H[enry] C. Hammond, F. Frederick Kennedy, and D. Field Yow. The spelling 'Fitzsimmons' (double-m) used by Hammond is consistent throughout this letter and represents a third surname variant alongside 'Fitz Simons' and 'FitzSimons' seen elsewhere in the album."
---
