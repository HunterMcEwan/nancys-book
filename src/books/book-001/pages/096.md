...
A handwritten letter page in brown ink. The hand is small and cramped but more legible than adjacent pages. An interlinear insertion ("Mitchell") is written above the line near "Margaret's little". Heavy staining in the lower left (ink/water bleed-through). A brief cross-written postscript runs down the right margin in the same hand, perpendicular to the body — only a single line is clearly legible.
...
*[Cross-written postscript running down the right margin, in the same hand, perpendicular to the body:]*

> Love to all [illegible — perhaps a list of names] L.B. [illegible — perhaps "keep"] the Boys & school[s]
