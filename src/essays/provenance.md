...
The [People index](/people/) and [Places index](/places/) are generated automatically from the frontmatter on each page. Add a person to a page's frontmatter and they appear in the People index; the same for a place. This means the index entries are not curated separately and cannot drift out of sync with the pages they point to.
